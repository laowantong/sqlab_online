...
export function createStrip(container, buttonsProperties, overviewButton = null) {
    ...
    // Start with the overview button if provided
    if (overviewButton) {
        overviewButton.classList.add('strip-button')
        overviewButton.classList.add('overview')
        stripButtons.appendChild(overviewButton);
    }
